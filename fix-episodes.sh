...
usage() {
    ...
    echo -e "  directory: A directory containing .mkv episodes with SXXEYY naming format"
    echo -e "             to change episode numbers."
    ...
    echo -e "             supporting the renaming of arbitrary files (e.g. shasums)."
